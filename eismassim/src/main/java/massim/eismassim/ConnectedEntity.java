...
public abstract class ConnectedEntity extends Entity {
    ...
    private synchronized void updatePercepts(Message msg) {
        ...
        if (msg instanceof SimStartMessage startMessage) {
        ...
        else if (msg instanceof RequestActionMessage rac) {
        ...
        else if (msg instanceof SimEndMessage endMessage) {
            simStartPercepts.clear();
            requestActionPercepts.clear();
            previousSimEndPercepts.clear();
    ...
    private boolean authenticate() {
        ...
        if (responseMsg instanceof AuthResponseMessage authResponse) {
